...
//    }
    ...
    public static void main(String[] args) {
        ...
        User u1 = new User("oded","123",LocalDate.parse("2007-02-03"),"oded","blu","eilat","israel");
        User u2 = new User("mich","12223",LocalDate.parse("2007-02-04"),"michael","mich","lod","israel");
    }
